...
public class WxPayController implements WxPayService {
    ...
    public WxPayUnifiedOrderResult unifiedOrder(@RequestBody WxPayUnifiedOrderRequest request) throws WxPayException {
        ...
        //LogUtils.logerror(WxPayController.class,request.toString());
        return this.wxService.unifiedOrder(request);
    }
    @PostMapping("/createSign")
    public R createSign(@RequestParam Map<String, String> params){
        Map<Object, Object> map = new HashMap<>();
        SortedMap<String, String> sortedMap = new TreeMap(params);
        //LogUtils.logerror(WxPayController.class,params.toString());
        ...
        toSign.append("key=").append(wxService.getConfig().getMchKey());
        //LogUtils.logerror(WxPayController.class,toSign.toString());
        map.put("paySign",DigestUtils.md5Hex(toSign.toString()).toUpperCase());
    ...
    public WxPayOrderNotifyResult parseOrderNotifyResult(@RequestBody String xmlData) throws WxPayException {
        //LogUtils.logerror(WxPayController.class,xmlData);
